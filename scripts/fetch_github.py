...
CATEGORIES = {
    'trending': {
        'name': '🔥 Trending',
        'desc': '近期最受欢迎的项目',
        'query': 'pushed:>2025-01-01 stars:>5000',
        'sort': 'stars'
    },
    'ai': {
        'name': '🤖 AI & ML',
        'desc': '人工智能、机器学习',
        'query': 'AI OR machine-learning OR deep-learning OR LLM OR GPT stars:>1000',
        'sort': 'stars'
    },
    'frontend': {
        'name': '💻 Frontend',
        'desc': '前端框架、UI库',
        'query': 'frontend OR react OR vue OR nextjs OR typescript language:javascript stars:>3000',
        'sort': 'stars'
    },
    'devtools': {
        'name': '🛠️ Dev Tools',
        'desc': '开发者工具、CLI',
        'query': 'developer-tools OR cli OR terminal OR vscode stars:>2000',
        'sort': 'stars'
    },
    'productivity': {
        'name': '⚡ Productivity',
        'desc': '效率工具、自动化',
        'query': 'productivity OR automation OR workflow OR notes stars:>1000',
        'sort': 'stars'
    },
    'fullstack': {
        'name': '🚀 Full Stack',
        'desc': '全栈框架',
        'query': 'fullstack OR nextjs OR nuxt OR trpc stars:>3000',
        'sort': 'stars'
    },
    'mobile': {
        'name': '📱 Mobile',
    ...
    'backend': {
        'name': '🗄️ Backend',
        'desc': '后端框架、数据库',
        'query': 'backend OR api OR database OR server OR microservice stars:>3000',
        'sort': 'stars'
    }
}
